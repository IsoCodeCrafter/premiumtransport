      ...
      (t) => (
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Araçlarımız grup sayısına göre fiyatlarımızda mesafe ve süre ye göre değiklik göstereceğinden 
            kesin fiyat bilgisi için iletişim bölümünden bize ulaşabilirsiniz 
          </p>
