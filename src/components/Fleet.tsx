...
const vehicles: Vehicle[] = [
  {
    ...
    images: [
      '/assets/Mercedes-Benz Sprinter1.jpg',
      '/assets/Mercedes-Benz Sprinter2.jpg',
      '/assets/Mercedes-Benz Sprinter3.jpg'
    ],
    capacity: 22,
    features: [
      'Ergonomik Koltuklar',
  ...
  },
  {
    ...
    description: 'Konforlu grup seyahatleri için ideal çözüm',
    images: [
      '/assets/Volkswagen Crafter1.jpg',
      '/assets/Volkswagen Crafter2.jpg',
      '/assets/Volkswagen Crafter3.jpg'
    ],
    capacity: 22,
    features: [
      'Ergonomik Koltuklar',
  ...
  },
  {
    ...
    images: [
      '/assets/Mercedes-Benz Vito VIP 1.jpeg',
      '/assets/Mercedes-Benz Vito VIP 2.jpeg',
      '/assets/Mercedes-Benz Vito VIP 3.jpeg'
    ],
    capacity: 8,
    features: [
  ...
  },
  {
    ...
    images: [
      '/assets/Mercedes-Vito Maybach1.jpeg',
      '/assets/Mercedes-Vito Maybach2.jpeg',
      '/assets/Mercedes-Vito Maybach3.jpeg'
    ],
    capacity: 8,
    features: [
      'Executive Koltuklar',
